...
public class GenresFuserFavourSource extends AttributeValueFuser<List<String>, VideoGames, Attribute> {
	...
	public void fuse(RecordGroup<VideoGames, Attribute> group, 
		...
		fusedRecord.setAttributeProvenance(VideoGames.GENRES, fused.getOriginalIds());
	}
}
